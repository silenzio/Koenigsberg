...
public class QueryKanteLesen {
	static Connection con = null;
	private String dbAdresse = "localhost";
	static GraphDatabaseFactory graphDatabaseFactory;
	public QueryKanteLesen(){
	}
	public List<String> eineKanteLesen(String titleAnfangsKnoten, String kantentyp, String titleEndKnoten) throws SQLException{
		...
		try {
			...
			e1.printStackTrace();
				...
				while(x.next() == true){
					...
					Fenster.InternesFensterKanteLesen.getKanteIdentifikator().setText(x.getString(1));
					reSx=x.getString(2);
				...
				if(sTokMenge==4){
					Fenster.InternesFensterKanteLesen.getKanteEigenschaftenSchluessel().setText(sTok.nextToken());
					Fenster.InternesFensterKanteLesen.getKanteEigenschaftenWert().setText(sTok.nextToken());
					Fenster.InternesFensterKanteLesen.getKanteEigenschaftenSchluessel_2().setText(sTok.nextToken());
					Fenster.InternesFensterKanteLesen.getKanteEigenschaftenWert_2().setText(sTok.nextToken());
				}
		return dataLoad;
	}
